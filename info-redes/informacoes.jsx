                    ...
                    <div className="col-lg-10">
                        ...
                        <div className="">
                            ...
                            <div className="list-group">
                                ...
                                <a href="#" className="list-group-item list-group-item-action"><strong>Característica do mercado de redes:</strong> <br />
                                    <ArrowRight className="ms-2 text-primary" size={18} /> Crescente demanda por profissionais de infraestrutura e conectividade <br />
                                    <ArrowRight className="ms-2 text-primary" size={18} /> Atuação em empresas públicas, privadas e provedores de internet <br />
                                    <ArrowRight className="ms-2 text-primary" size={18} /> Oportunidades em suporte técnico, administração e segurança de redes<br />
                                    <ArrowRight className="ms-2 text-primary" size={18} /> Necessidade constante de atualização tecnológica <br/>
                                    <ArrowRight className="ms-2 text-primary" size={18} /> Certificações técnicas como diferencial competitivo
                                </a>
                            </div>
